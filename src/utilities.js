...
exports.generateRoutes = function(arr) {
    ...
    arr.forEach(function(eachObj) {
        ...
        if ('pageData' in eachObj["component"]) {
            ...
            if ('posted' in eachObj["component"].pageData) {
                _obj.posted = new Date(String(eachObj["component"].pageData.posted).replace(/-/g, "/"))
            } else {
                _obj.posted = _obj.created
            }
