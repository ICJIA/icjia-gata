...
<li>The Coalition should organize at least one community event during the grant period.</li></ul></li>
<li><p>Educate public about program services through wide distribution and various types of program materials, public presentations and awareness events.</p></li>
<li>Implementation of at least one of the following direct service categories: <br>
<ul><li>Street Intervention/Interruption-Active Outreach and Engagement – Programs target at-risk youth and young adults in order to provide crisis intervention and de-escalation of high stress situations. o Examples of promising programs include Richmond Comprehensive Homicide Initiative, CureViolence, Operation Ceasefire, and Safe Streets. </li>
...
<li>Case Management- Supporting youth and their families in identifying and accessing resources. Individuals at risk for involvement in street-level violence can be difficult to engage in services. Case management approaches that actively engage youth and families (i.e., active reaching out, meeting youth/families in the home, community engagement) are more effective at long-term client retention and developing trust than more passive case management approaches (i.e., requiring youth/families to meet in office locations). </li>
<li>Youth Development - Engaging young people to develop their emotional, physical, social and intellectual selves. Program provides opportunities for youth to practice conflict resolution and prosocial life skills. Promising programs include the Life Skills Training (LST). </li></ul></li>
...
<p>This solicitation is not open to Cure Violence/CeaseFire (University of Illinois at Chicago) and its sub-grantees for similar activities for the same population. </p>



<h3 id="eligible-agencies-and-gata-compliance">Eligible agencies and GATA compliance</h3>

<p>This solicitation is open to public and not-for-profit entities providing community-based violence prevention and intervention services in the State of Illinois. </p>
...
<p>The pre-qualification process also includes a financial and administrative risk assessment using an Internal Controls Questionnaire (ICQ). The ICQ must be submitted through the GATA portal by the date of application submission in order for an application to be reviewed.  All applications will be pre-screened for completeness and ICQ submission. Applications from agencies that have not submitted their SFY18 ICQ will not be reviewed.</p>



<h2 id="notice-of-funding-opportunity">NOTICE OF FUNDING OPPORTUNITY</h2>

<p>Read the <a href="/static/grants/2017ViolenceInterventionAndPrevention/CBvipNOFO.pdf">Notice of Funding Opportunity</a>. </p>



<h3 id="deadline">Deadline</h3>

<p>Applications are due at 11:59 p.m., Thursday, August 18, 2017. Completed application materials must be emailed to <a href="mailto: CJA.StateViolencePrevention@Illinois.gov">CJA.StateViolencePrevention@illinois.gov</a>.</p>
...
<p>A total of <span>$</span>7.2 million is available through this opportunity.  Applicants may request a minimum of <span>$</span>100,000 to a maximum of $1,000,000 in federal funding for use over a nine-month period. Agreements that result from this funding opportunity are contingent upon and subject to the availability of funds.</p>



<h4 id="period-of-performance">Period of Performance</h4>

<p>The projected period of performance for awards resulting from this opportunity is October 1, 2017, through June 30, 2018. Contingent on satisfactory performance and available funds, ICJIA may support 24 additional months of funding for each project. </p>
...
<p>Completed application materials must be emailed to CJA.StateViolencePrevention@Illinois.gov by 11:59 p.m., August 18, 2017, to be considered for funding.  Proposals will not be accepted by mail, fax, or in-person. Incomplete applications will not be reviewed. Late submissions will not be reviewed.</p>
...
<tr>
  <td>Completed Program Narrative in Word that meets program requirements outlined in Section A. Applicant’s narrative must be submitted in Word and formatted in the posted Program Narrative. Application should be 20 pages maximum, not counting Goals/Objectives/Performance Measures, drafted in Times New Roman 12-point font and double-spaced with 1 inch margins. Please number pages.</td>
  <td></td>
  <td align="center"></td>
  <td></td>
  <td align="center">X</td>
...
<ul>
<li><a href="/static/grants/2017ViolenceInterventionAndPrevention/CBvipApplication.docx">Uniform Application</a> </li>
<li><a href="/static/grants/2017ViolenceInterventionAndPrevention/CBvipNarrative.docx">Community Violence Program Narrative</a></li>
<li><a href="/static/grants/2017ViolenceInterventionAndPrevention/CBvipBudget.xlsx">Uniform Budget Template</a></li>
</ul>
